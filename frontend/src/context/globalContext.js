...
const BASE_URL = "https://render-demo-deployment.onrender.com/api/v1/";
...
export const GlobalProvider = ({ children }) => {
    ...
    const addIncome = async (income) => {
        const response = await axios.post(`${"https://render-demo-deployment.onrender.com/api/v1/"}addIncome`, income)
            .catch((err) => {
